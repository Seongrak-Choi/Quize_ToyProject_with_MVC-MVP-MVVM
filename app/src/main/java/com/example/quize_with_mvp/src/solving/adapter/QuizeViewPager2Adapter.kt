...
import com.example.quize_with_mvp.src.result.ResultActivity
import com.example.quize_with_mvp.src.solving.data.Quize

class QuizeViewPager2Adapter(private val quizeList : ArrayList<Quize>, val name:String) : RecyclerView.Adapter<QuizeViewPager2Adapter.ViewHolder>()  {
    private var score = 0
